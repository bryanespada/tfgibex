...
from appmodels.models import Subscription, Mercado, Bolsa, Empresa, Product
...
class AdminsLog(GeneralLog):
    ...
    """
    item = models.CharField(max_length=100) # Options: Mercado, Bolsa, Empresa, Parameters, Subscription, Product
